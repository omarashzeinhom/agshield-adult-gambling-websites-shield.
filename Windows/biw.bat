...
ECHO 2. Changing DNS Servers (CloudFlare)    Win10
ECHO 3. Changing DNS Servers (Family Sheild) Win10 
ECHO 4. Changing DNS Servers (Family Sheild) Win 7
...
IF ERRORLEVEL 4 GOTO Changing DNS Servers (CloudFlare) Windows 7
IF ERRORLEVEL 3 GOTO Changing DNS Servers (CloudFlare)
IF ERRORLEVEL 2 GOTO Changing DNS Servers (Family Sheild)
...
:Changing DNS Servers (Family Sheild) 
...
:Changing DNS Servers (CloudFlare)
ECHO "Changing Search Engine Results to Safe Family (CloudFlare Family DNS)."
    ...
    netsh interface ipv6 set dns "Wi-Fi" static 2606:4700:4700::1113
    netsh interface ipv6 add dns "Wi-Fi" 2606:4700:4700::1003 index=2

    ECHO  " Changing DNS Of This PC-Only Ethernet ...."


    netsh interface ipv4 set dns "Ethernet" static 1.1.1.3 primary
    netsh interface ipv4 add dns "Ethernet"  1.0.0.3 index=2
    netsh interface ipv6 set dns "Ethernet" static 2606:4700:4700::1113 primary
    ...
    netsh interface ipv6 add dns "Wi-Fi" static 2606:4700:4700::1113 primary
;;
